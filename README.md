...
- `/v1/events?region=ukraine-east&publication=published` returns event resources with location, granular `eventType`, review state, extraction metadata, visible original source links, collector provenance, source country/language metadata, and map/detail/API links.

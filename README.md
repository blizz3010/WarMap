...
- `POST /api/review-export` validates one decision payload or a `{ decisions: [...] }` batch and returns a commit-ready static decision module for `api/editorial-decisions.js` when Vercel writes are not configured yet.

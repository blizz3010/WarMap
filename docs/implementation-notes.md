...
- Standalone review page: `/review?region=...&lookback=...` renders queued candidates with granular event types, source links, extraction metadata, correction fields, dossier links, reviewer-token storage, reviewer identity, status/assignee/priority filters, and publish/hold/reject/merge/split actions.
